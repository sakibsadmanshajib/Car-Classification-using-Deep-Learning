...
classes, c_to_idx, CLASS_NUM = find_classes()

def create_model(model_path, num_classes=CLASS_NUM):
...
def eval_model(model_path, image_path):
    model = create_model(model_path, CLASS_NUM)
    model.eval()
...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--image', type=str, default='', help='input image for classification')
